...
ggplot(mob_state, aes(x=state_lynch, y=percent_hostile)) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "State", y = "Percent Hostile", title = "Southern Hostile Mob Portrayal Percentages") +
    theme_bw() +
    theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1)) 

ggplot(mob_state, aes(x=state_lynch, y=percent_neutral)) +
    geom_bar(stat = "identity", position = "dodge") +
    labs(x = "State", y = "Percent Neutral", title= "Southern Neutral Mob Portrayal Percentages") +
    theme_bw() +
    theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))

ggplot(mob_state, aes(x=state_lynch, y=percent_orderly)) +
    geom_bar(stat = "identity", position = "dodge") +
  labs(x = "State", y = "Percent Orderly", title = "Southern Orderly Mob Portrayal Percentages") +
  theme_bw() +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))

#Hostile, Neutral, Orderly Percentages for Northeast states: CT, ME, NJ, NY and PA.

ggplot(mob_northeast, aes(x=state_lynch, y=percent_hostile)) +
    geom_bar(stat = "identity", position = "dodge") +
  labs(x = "State", y = "Percent Hostile", title = "Northeast Hostile Mob Portrayal Percentages") +
  theme_bw() +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))

ggplot(mob_northeast, aes(x=state_lynch, y=percent_neutral)) +
    geom_bar(stat = "identity", position = "dodge") +
  labs(x = "State", y = "Percent Neutral",title = "Northeast Neutral Mob Portrayal Percentages") +
   theme_bw() +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))

ggplot(mob_northeast, aes(x=state_lynch, y=percent_orderly)) +
    geom_bar(stat = "identity", position = "dodge") +
  labs(x = "State", y = "Percentage Orderly", title = "Northeast Orderly Mob Portrayal Percentages") +
   theme_bw() +
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1)) 
