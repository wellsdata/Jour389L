...
white_women <- filtered_bigrams |>
  filter(word2=="woman" | word2=="women") |>
  mutate(phrase = paste(white_women$word1, white_women$word2, sep=" ")) |>
  select(-word1, -word2)
  
white_girls <- filtered_bigrams |>
  filter(word2=="girl" | word2=="girls") |>
  mutate(total = sum(n))

white_ladies <- filtered_bigrams |>
  filter(word2=="lady" | word2=="ladies") |>
  mutate(total = sum(n))

write_csv(white_women, "~/Desktop/white_women_bigrams.csv")
```