...
arkansas <- c("A", "Ark", "Arkcurrent", "Faulkne")
california <- c("Butte", "Ca", "Cal", "Calif", "El", "ElDora", "Placer")
...
iowa <- c("Audubo", "CedarC", "How", "Howard", "Io", "Iow", "Maha", "TamaCo", "Winnes")
kansas <- c("Allen Cou", "K", "Ka", "Kan", "Kansa")
...
minnesota <- c("Be", "Bemidji", "BlueE", "Brown", "Goodh", "Min", "Minn", "MT", "PineCou", "Stevens", "StL")
...
montana <- c("MTM", "Mont", "Montcurrent")
nebraska <- c("BoxB", "Cher", "H","Neb", "Nebr", "Nebras", "Nebrask", "Nem", "Webs")
nevada <- c("Nev", "NT")
new_hampshire <- c()
new_jersey <- c("NJ")
...
north_dakota <- c("Billings", "Bott", "D", "DickeyC", "DT", "Gr", "McLea", "ND", "Richl", "Stark", "Stut", "Ward", "WardCou", "Will")
...
virginia <- c("Augus", "Highl", "V")
washington <- c("Cheha", "OT", "Wa", "Wash", "Washin", "WT")
w_dc <- c("DC")
west_virginia <- c("VaW", "WV", "WVa")
...
clean_main_index <- main_index %>% 
  ...
  mutate(newspaper_state_clean = case_when(
    ...
    newspaper_state_clean %in% mississippi | (newspaper_state_clean == "M" & str_detect(newspaper_city, "Philadelphia")) | (newspaper_state_clean == "Mi" & str_detect(newspaper_city, "Hattiesburg|Leakesville|Poplarville|Port Gibson"))
  ))

"M & Philadelphia", "MT", "Marshal", "Mis", "Miss", "Stone", "Hattiesburg & Mi", "Leakesville & Mi", "Poplarville & Mi", "Port Gibson & Mi

y <- clean_main_index %>% 
  count(newspaper_state_clean) %>% 
  arrange(desc(n))

mi_papers <- clean_main_index %>% 
  filter(newspaper_state_clean == "Mi")
...
Colorado: "Ba", "Co & Canon City", "Col", "Colo", "Conejo", "DeltaCo", "Elbert", "Logan", "Montez", "RubyCaGunnisonCountyColo", "Wel", "WeldCou
...
Minnesota: "Be", "Bemidji", "BlueE", "Brown", "C & Cook County", "Goodh", "M & Little Falls", "M & Fergus Falls", "M & Grand Marais", "M & Sauk Rapids", "Min", "Minn", "MT", "PineCou", "St (Excepting Missouri)", "Stevens", "StL", "Minneapolis & Mi", "White Earth & Mi", "Worthington & Mi
...
Nebraska: "BoxB", "Cher", "H", "N & North Platte", "N & Grand Island", "Ne & Nemaha City", "Ne & Dakota City", "Neb", "Nebr", "Nebras", "Nebrask", "Nem", "Webs
...
North Dakota: "Billings", "Bott", "D", "Dakot & Bismarck", "Dakota & Pembina", "DickeyC", "DT", "Gr", "McLea", "N & Valley City", "N & Grand Forks", "ND", "Richl", "Stark", "Stut", "Ward", "WardCou", "Will
...
South Dakota: "Bl", "Broo", "Brule", "Bu & Dakota", "Dako", "Dakot & Mitchell", "S (Excepting NJ)", "Dakota & Hurley", "Dakota & Miller", "DayCo", "DTS", "Haakon", "HandCo", "Pen", "Rober", "SD", "South", "Stanley", "Unio
...
Washington: "Cheha", "OT", "North Yakima & W", "White Bluffs & W", "Wa", "Wash", "Washin", "WT
Washington D.C.: "DC
West Virginia: "Charles Town & V", "Charlestown & Va", "Clarksburg & Va", "Lewisburg & Va", "Morgantown & Va", "Wheeling & Va", "VaW", "WV", "WVa
