...
for (i in 1:nrow(counting_wire_cases)) {
  ...
  if (i == 1) {
    ...
    if (!is.na(counting_wire_cases$address[i - 1]) && !is.na(counting_wire_cases$address[i]) && !is.na(counting_wire_cases$date[i - 1]) && !is.na(counting_wire_cases$date[i]) &&
        counting_wire_cases$address[i] == counting_wire_cases$address[i - 1] && counting_wire_cases$date[i] == counting_wire_cases$date[i - 1]) {
